 ...
 */
class TomorrowCommand extends SystemCommand
{
	/**
	 * @var string
	 */
	 ...
	 * @var string
	 */
	protected $description = 'Расписание на завтра';

	/**
	 * @var string
	 */
	protected $usage = '/tomorrow';
	...
	public function execute()
	{
		...
		if ($client->checkActivity()) {
			...
			if (false != $diary) {
				$diaryDay = $diary->getDiaryDay(Date::getNearestWorkDay());
